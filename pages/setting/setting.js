...
Page({
  data: {
    ...
    imgurl:'cloud://b2-7gkwgld706d8a245.6232-b2-7gkwgld706d8a245-1322544397/一般_用户.png',
    photo: '',
    person:0//用户是否存在
  },
    ...
    wx.chooseMedia({
      ...
      success(res) {
        ...
        wx.cloud.uploadFile({
          ...
          console.log("云存储的头像路径url",that.data.imgurl)
 ...
 .update({
  ...
  onLoad(options){
    ...
    this.setData({
      ...
      imgurl:res.data[res.data.length-1].photo,
      name:res.data[res.data.length-1].name,
    })
      console.log("获取的用户头像",this.data.imgurl)
